...
namespace Test1
{
    class GRectangle 
    {
        ...
        private bool crumbs;  // If we were here, lay down a trail 
        private bool trace; // true only if we travelled thru here
        public GRectangle(int X, int Y, int Width, int Length, bool Wall, int I, int J)
        {
            Up = false; Down = false; Left = false; Right = false; trace = false;
            counter = 0;
        ...
        public bool getCrumbs()
        {
            return crumbs;
        }
        public void setCrumbs(bool Crumbs)
        {
            crumbs = Crumbs;
        }
